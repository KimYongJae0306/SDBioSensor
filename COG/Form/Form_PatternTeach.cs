...
namespace COG
{
    public partial class Form_PatternTeach : Form
    {
        ...
        private void TABC_MANU_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(TABC_MANU.SelectedTab.Tag) == 6 || Convert.ToInt32(TABC_MANU.SelectedTab.Tag) == 5)
            {
                ...
                else
                {
                    ...
                    RDB_MATERIAL_ALIGN.PerformClick();
                }
        ...
        private void Insp_Ingroe(object sender, EventArgs e)
        {
            Button btn = (Button)sender;
            int iIngroe = Convert.ToInt32(text_Insp_Ignore.Text);
            if (Convert.ToInt32(btn.Tag.ToString()) == 0)
            {
                //Up
                iIngroe++;
            ...
            if (m_enumROIType == enumROIType.Line)
                m_TempFindLineTool.RunParams.NumToIgnore = iIngroe;
            else
                m_TempFindCircleTool.RunParams.NumToIgnore = iIngroe;
            text_Insp_Ignore.Text = iIngroe.ToString();
        }
        ...
        {
            bLiveStop = true;
            PT_Display01.Image = PT_Pattern[m_PatNo, m_PatNo_Sub].Pattern.TrainImage;
        }
        private void btnAlignInspPos(object sender, EventArgs e)
        {
            ...
            Get_FindConerParameter();
            btn_align_roi_show.PerformClick();
        }
        ...
        private void btn_align_roi_show_Click(object sender, EventArgs e)
        {
            ...
            //    double StartA_X = m_TempTrackingLine.RunParams.ExpectedLineSegment.StartX - TranslationX;
            //    double StartA_Y = m_TempTrackingLine.RunParams.ExpectedLineSegment.StartY - TranslationY;
            //    double EndA_X = m_TempTrackingLine.RunParams.ExpectedLineSegment.EndX - TranslationX;
            //    double EndA_Y = m_TempTrackingLine.RunParams.ExpectedLineSegment.EndY - TranslationY;
            //}
            TrakingLineROI();
        }
        ...
        private void FindConerTest()
        {
            //m_TempTrackingLine.InputImage = (CogImage8Grey)PT_Display01.Image;
            //CogGraphicInteractiveCollection resultGraphics = new CogGraphicInteractiveCollection();
            //m_TempTrackingLine.Run();
            //if (m_TempTrackingLine.Result != null || m_TempTrackingLine.Result.CornerFound != false)
            //{
            //    for (int i = 0; i < m_TempFindCorner.Result.LineResultsA.Count; i++)
            //    {
            //        resultGraphics.Add(m_TempFindCorner.Result.LineResultsA[i].CreateResultGraphics(CogFindLineResultGraphicConstants.All));
            //    }
            //    for (int i = 0; i < m_TempFindCorner.Result.LineResultsB.Count; i++)
            //    {
            //        resultGraphics.Add(m_TempFindCorner.Result.LineResultsB[i].CreateResultGraphics(CogFindLineResultGraphicConstants.All));
            //    }
            //}
            //PT_Display01.InteractiveGraphics.AddList(resultGraphics, "RESULT", false);

        }
        private void Spec_Distance(object sender, EventArgs e)
        {
            Button btn = (Button)sender;
            double dDistance = Convert.ToDouble(text_Spec_Dist.Text);
            if (Convert.ToInt32(btn.Tag.ToString()) == 0)
            {
                //Up
                dDistance++;
            ...
            m_SpecDist = dDistance;
            text_Spec_Dist.Text = m_SpecDist.ToString(); // cyh - ToString -> c#에서 형변환 
        }
        ...
        private void rdoSelectXYPosition_Click(object sender, EventArgs e)
        {
            ...
            //if (btn.Tag.ToString() == Convert.ToInt32(_bondingAlignPosition).ToString())
        ...
        private void GetBondingAlignParameters()
        {
            ...
            ////shkang_s Test
            //Cognex.VisionPro.Implementation.CogObjectBase TLQKF = new CogObjectBase();
            //TLQKF.C
            //CogCaliperScorerContrast tt = new CogCaliperScorerContrast();
            //tt.SetXYParameters(255, 0, 0, 1, 0);

            //m_TempCaliperTool.CreateObjRef(tt);
        ...
        private void RDB_ALIGN_TEACH_MODE_Click(object sender, EventArgs e)
        {
            ...
            switch (Convert.ToInt32(TempRadioButton.Tag))
            {
                case 1://자재 얼라인 
                    ...
                    PANEL_MATERIAL_ALIGN.Size = new Size(855, 376);
        ...
        private void BTN_ROI_FINEALIGN_Click(object sender, EventArgs e)
        {
            ...
            //    double TranslationX = PT_Pattern[m_PatNo, m_PatNo_Sub].Pattern.Origin.TranslationX - PatResult.TranslationX;
            //    double TranslationY = PT_Pattern[m_PatNo, m_PatNo_Sub].Pattern.Origin.TranslationY - PatResult.TranslationY;
            //    bSearchRes = TrackingROI(PatResult.TranslationX, PatResult.TranslationY, TranslationX, TranslationY);
            //}
            //if (!bSearchRes)
            //{
            //    LabelText.Text = "Please Material Align and Bonding Align Check!!";
            ...
            //m_FixtureImage = (CogImage8Grey)PT_Display01.Image;
